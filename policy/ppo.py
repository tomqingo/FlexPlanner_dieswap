...
class ClipLossCoef:
    def __init__(self, pos_coef:float, ratio_coef:float, async_place_coef:float, async_place:bool) -> None:
        self.pos = pos_coef
        ...
        if async_place:
            ...
            self.layer = 0.0
            self.layerdst = async_place_coef
            #print("self.layerdst: ", self.layerdst)
...
class EntropyLossCoef:
    def __init__(self, pos_coef:float=1.0, ratio_coef:float=1.0, async_place_coef:float=1.0, async_place:bool=True) -> None:
        self.pos = pos_coef
        self.ratio = ratio_coef
            ...
            for minibatch in batch.split(batch_size, merge_last=True):
                try:
                    ...
                    for key in dist.keys():
                        ...
                        #print(clip_loss_curr, getattr(self.clip_loss_coef, key))
