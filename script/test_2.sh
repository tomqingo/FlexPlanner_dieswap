...
alignment_rate=0.1
alignment_sort=area
input_alignment_mask=0
use_alignment_constraint=0

# reward_weight_alignment=0.5
reward_weight_alignment=0.0
...
checkpoint=result/train_n100/checkpoint/policy-000500.pt
load_optimizer=
statistics=
max_epoch_new=
