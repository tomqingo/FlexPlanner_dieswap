...
def get_args():
    ...
    parser.add_argument('--reward_weight_via', type=float, default=1.0, help='reward weight via')
    ...
    args.async_place_coef = args.async_place_coef
    args.async_place_entropy_coef = args.async_place_entropy_coef
